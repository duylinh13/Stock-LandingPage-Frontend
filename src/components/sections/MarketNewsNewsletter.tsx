...
const MarketNewsNewsletter = () => {
  return (
    <div>
      <div className="py-16 ">
        <div className="flex bg-blue-950 rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl ">
          ...
          <div className="w-full p-8 lg:w-1/2">
            ...
            >
              ...
              <h1 className="px-4 py-3 w-5/6 text-center text-gray-100 ">
                Sign in with Google
              </h1>
            </a>
            ...
            <div className="my-6 sm:my-8 items-center flex justify-center">
              <Button
                label="Get Started"
                variant="primary"
