...
const HeroSection = () => {
  return (
    <div className="text-center mt-8 sm:mt-14 px-4 sm:px-0">
      ...
      <p className="text-sm sm:text-base lg:text-lg text-gray-600 leading-relaxed sm:leading-normal">
      ...
      {/* Icon List */}
      <ul className="flex flex-wrap justify-center gap-6 sm:gap-10 mt-4 text-[14px] sm:text-[16px] text-gray-500">
